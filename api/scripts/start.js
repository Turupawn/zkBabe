...
const BABE_ADDRESS = "0x24EF68753793b732972E83B67B70409D4049A487"
...
const babeABI = require('../json_abi/Babe.json')
...
const babeContract = new Contract(babeABI, BABE_ADDRESS)
...
async function serveMetadataBabe(res, nft_id) {
  var token_count = parseInt(await babeContract.methods.totalSupply().call())
  let return_value = {}
  if(nft_id <= 0)
  {
  ...
  }else
  {
    return_value = {
      ...
      "image": metadataAPIURL + "/babeEquiped/" + nft_id + ".png",
      "attributes":[
        /*
    ...
    //return_value = fs.readFileSync("./metadata/babe/" + nft_id).toString().trim()
  }
...
app.get('/metadata/babe/:id', (req, res) => {
  ...
  {
    serveMetadataBabe(res, req.params.id)
  }
})
...
async function updateMetadata(res, characterId) {
  ...
  // Reset uhm
  var characterTypeId = await babeContract.methods.getCharacterType(characterId).call()
  mergeImages("./images/babeTypes/" + characterTypeId + ".png",
  "./images/babeTypes/" + characterTypeId + ".png",
  "./images/babeEquiped/" + characterId + ".png")
  ...
  if(weaponEquipmentId != "0")
  {
    ...
    mergeImages("./images/babeEquiped/" + characterId + ".png",
      "./images/wearableTypes/" + wearableType + ".png",
      "./images/babeEquiped/" + characterId + ".png")
  }
